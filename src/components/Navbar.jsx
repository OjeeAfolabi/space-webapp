...
const Navbar = () => {
  ...
  return (
    <nav
     ...
     fixed top-0 w-screen py-3 px-5 md:px-0 md:pl-10 md:py-0"
    >
      <img
        className="h-10"
      ...
      <NavLink  to={"/"} className={
        ({isActive}) => isActive ? "border-b-2 border-white" : "flex items-center gap-2"
      }>
      ...
      <div className="md:hidden">
        <span className="text-black" onClick={() => setShow((prev) => !prev)}>
          {show ? (
